...
def run():
    ...
    response = inf_stub.InferenceLocal(inf_pb2.InferRequest(
        bid=return_bid,
        uuid=auuid,
        path="/home/ubuntu/ar_example_storage/models/tfpy_unfrozen_sgcc/img_result/val00012.jpg",
        type="",
        base64="",
    ))
    ...
    # InferenceRemote
    img = Image.open("/home/ubuntu/ar_example_storage/models/tfpy_unfrozen_sgcc/img_result/val00012.jpg")
    out_buffer = BytesIO()
