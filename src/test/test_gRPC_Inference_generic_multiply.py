...
def createAndLoadModelV2(stub):
    load_info = {
        'backend': {'impl': "traditional-generic.algorithmMultiple"},
        'model': {
            'fullhash': "1f9783be56170d830cf87a4823f67a3a-1",
            'implhash': "1f9783be56170d830cf87a4823f67a3a",
            'version': "1",
        },
        'encrypted': 0,
        'a64key': "",
...
def createAndLoadModel(stub):
    load_info = {
        'backend': {'impl': "traditional-cv.algorithmMultiple"},
        'model': {
            'implhash': "1f9783be56170d830cf87a4823f67a3a",
            'version': "1",
        },
